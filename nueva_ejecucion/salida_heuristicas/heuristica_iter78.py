    ...
    while improvement_made:
        ...
        for unsel_density, unsel_value, unsel_weight, unsel_idx in temp_unselected_items_list_by_value:
            ...
            for sel_value, sel_weight, sel_idx in temp_selected_item_info:
                # Removed redundant check: if sel_idx not in current_selected_items_indices: continue
        ...
        for sel_value, sel_weight, sel_idx in temp_selected_item_info:
            ...
            for unsel_density, unsel_value, unsel_weight, unsel_idx_to_add in temp_unselected_items_list_by_density:
                # Removed redundant check: if unsel_idx_to_add in current_selected_items_indices or unsel_idx_to_add == sel_idx: continue
        ...
        for i in range(len(temp_selected_item_info)):
            ...
            # Removed redundant check: if sel1_idx not in current_selected_items_indices: continue

            for j in range(i + 1, len(temp_selected_item_info)):
                sel2_value, sel2_weight, sel2_idx = temp_selected_item_info[j]
                # Removed redundant check: if sel2_idx not in current_selected_items_indices: continue
                ...
                for unsel_density, unsel_value, unsel_weight, unsel_idx in temp_unselected_items_list_by_value:
                    ...
                    # Removed redundant checks: if unsel_idx in current_selected_items_indices or unsel_idx == sel1_idx or unsel_idx == sel2_idx: continue
