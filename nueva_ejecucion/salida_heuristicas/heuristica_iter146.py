def heuristic(items_state):
    ...
    while improvement_made:
        ...
        for unsel_density, unsel_value, unsel_weight, unsel_idx in temp_unselected_items_list_by_value:
            ...
            for sel_value, sel_weight, sel_idx in temp_selected_item_info_by_value_asc: # Using value-sorted list
        ...
        for i in range(len(temp_selected_item_info_by_value_asc)): # Using value-sorted list
