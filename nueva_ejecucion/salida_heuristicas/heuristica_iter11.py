def heuristic(items_state):
    ...
    while improvement_made:
        ...
        # Selected items are sorted by value ascending (candidates for removal in 1-for-1 and 1-for-k).
        ...
        for unsel_density, unsel_value, unsel_weight, unsel_idx in temp_unselected_items_list_by_value:
            ...
            # This check is important because temp_unselected_items_list_by_value is a snapshot.
            ...
            for sel_value, sel_weight, sel_idx in temp_selected_item_info:
                ...
                # This check is important because temp_selected_item_info is a snapshot.
        ...
        if not improvement_made:
            ...
            for sel_value, sel_weight, sel_idx in temp_selected_item_info:
                ...
                for unsel_density, unsel_value, unsel_weight, unsel_idx in temp_unselected_items_list_by_density:
                    # No need for if unsel_idx in current_selected_items_indices or unsel_idx == sel_idx:
                    # because temp_unselected_items_list_by_density only contains items from unselected_items_dict,
                    # and sel_idx is not in unselected_items_dict at this point.
                ...
                if temp_current_total_value + potential_add_value > current_total_value:
                    ...
                    for add_idx in potential_add_indices:
                        ...
                        # It's safe to use del here because potential_add_indices are derived
                        # from unselected_items_dict at the start of the while iteration,
                        # and only one swap is applied per while iteration.
