def heuristic(items_state):
    ...
    while improvement_made:
        ...
        # This phase attempts to replace one selected item with multiple unselected items
        ...
        if not improvement_made:
            ...
            for sel_value, sel_weight, sel_idx in temp_selected_item_info:
                ...
                # Temporarily remove sel_idx to free up capacity
                ...
                # Greedily fill available_capacity with unselected items by density
