def heuristic(items_state):
    ...
    while improvement_made:
        ...
        for idx in current_selected_items_indices:
            temp_selected_item_info_by_weight_desc.append((weights[idx], values[idx], idx)) # Note order of (weight, value, idx)
        ...
        for unsel_density, unsel_value, unsel_weight, unsel_idx in temp_unselected_items_list_by_value:
            ...
            for sel_value, sel_weight, sel_idx in temp_selected_item_info_by_value_asc: # Use by_value_asc
        ...
        for i in range(len(temp_selected_item_info_by_value_asc)): # Use by_value_asc
