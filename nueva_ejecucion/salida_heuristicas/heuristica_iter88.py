    ...
    while improvement_made:
        ...
        for sel_value, sel_weight, sel_idx in temp_selected_item_info:
            ...
            for unsel_density, unsel_value, unsel_weight, unsel_idx_to_add in temp_unselected_items_list_by_density:
                ...
                # - unsel_idx_to_add in current_selected_items_indices or unsel_idx_to_add == sel_idx
                #   because unselected items are by definition not selected, and sel_idx is selected.
                # - unsel_weight == 0 and unsel_value > 0 block
                #   because Phase 0 ensures all such items are already added.
        ...
        for i in range(len(temp_selected_item_info)):
            ...
            for j in range(i + 1, len(temp_selected_item_info)):
                ...
                for unsel_density, unsel_value, unsel_weight, unsel_idx in temp_unselected_items_list_by_value:
                    ...
                    # unsel_idx in current_selected_items_indices or unsel_idx == sel1_idx or unsel_idx == sel2_idx
                    # because unselected items are by definition not selected, and sel1_idx/sel2_idx are selected.
