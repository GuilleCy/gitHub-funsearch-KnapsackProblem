def heuristic(items_state):
    ...
    while improvement_made:
        ...
        # NEW: Two sorts for selected items based on usage in swap phases
        ...
        # Sort by weight DESC (negative of weight), then value ASC
        temp_selected_item_info_by_weight_desc.sort(key=lambda x: (-x[0], x[1])) 
        ...
        for unsel_density, unsel_value, unsel_weight, unsel_idx in temp_unselected_items_list_by_value:
            ...
            for sel_value, sel_weight, sel_idx in temp_selected_item_info_by_value_asc: # Use value_asc for removal
        ...
        for sel_weight, sel_value, sel_idx in temp_selected_item_info_by_weight_desc: # Note order of (weight, value, idx)
            ...
            for unsel_density, unsel_value, unsel_weight, unsel_idx_to_add in temp_unselected_items_list_by_density:
                ...
                # Removed redundant check: if unsel_weight == 0 and unsel_value > 0: ... continue
        ...
        for i in range(len(temp_selected_item_info_by_value_asc)): # Use value_asc for removal
            ...
            for j in range(i + 1, len(temp_selected_item_info_by_value_asc)):
                ...
                for unsel_density, unsel_value, unsel_weight, unsel_idx in temp_unselected_items_list_by_value:
                    ...
                    # Removed redundant check: if unsel_idx in current_selected_items_indices or unsel_idx == sel1_idx or unsel_idx == sel2_idx: ... continue
