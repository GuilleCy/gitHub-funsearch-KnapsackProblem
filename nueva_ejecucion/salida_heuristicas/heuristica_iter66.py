def heuristic(items_state):
    ...
    while improvement_made:
        ...
        # Tie-break by weight descending: if values are equal, remove heavier to free more space.
        ...
        # Tie-break by density descending: if values are equal, add more dense item.
        ...
        # Tie-break by value descending: if densities are equal, add more valuable item.
