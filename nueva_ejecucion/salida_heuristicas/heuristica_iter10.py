def heuristic(items_state):
    ...
    # IMPROVEMENT 1: Use a dictionary for unselected items for efficient O(1) add/remove by index.
    ...
    while improvement_made:
        ...
        # IMPROVEMENT 2: Phase 2: 1-for-k swaps (only if no 1-for-1 improvement in this iteration)
        # This phase attempts to improve the solution by removing one item and greedily adding multiple
        # unselected items to fill the freed capacity, potentially escaping local optima.
