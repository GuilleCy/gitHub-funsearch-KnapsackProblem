def heuristic(items_state):
    ...
    while improvement_made:
        ...
        for unsel_density, unsel_value, unsel_weight, unsel_idx in temp_unselected_items_list_by_value:
            ...
            for sel_value, sel_weight, sel_idx in temp_selected_item_info_by_value_asc: # Use value_asc
        ...
        for i in range(len(temp_selected_item_info_by_value_asc)): # Use value_asc
            sel1_value, sel1_weight, sel1_idx = temp_selected_item_info_by_value_asc[i]

            for j in range(i + 1, len(temp_selected_item_info_by_value_asc)): # Use value_asc
