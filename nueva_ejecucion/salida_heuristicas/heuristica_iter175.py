def heuristic(items_state):
    ...
    while improvement_made:
        ...
        temp_selected_item_info_by_value_asc.sort(key=lambda x: (x[0], -x[1])) # CHANGED: -x[1] for weight DESC
        ...
        for unsel_density, unsel_value, unsel_weight, unsel_idx in temp_unselected_items_list_by_value:
            ...
            # Try 1-for-1 swap with selected items (lowest value first, heaviest if values are equal)
