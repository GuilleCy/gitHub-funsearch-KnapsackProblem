def heuristic(items_state):
    ...
    while improvement_made:
        ...
        for sel_value, sel_weight, sel_idx in temp_selected_item_info:
            ...
            # (Note: this check is not strictly needed here as temp_selected_item_info is a snapshot,
            # but it ensures robustness if current_selected_items_indices changes mid-iteration,
            # though the 'continue' in earlier phases prevents that).
