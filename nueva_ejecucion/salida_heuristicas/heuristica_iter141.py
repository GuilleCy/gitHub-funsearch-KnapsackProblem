def heuristic(items_state):
    ...
    while improvement_made:
        ...
        for unsel_idx in list(unselected_items_dict.keys()):
            # Retrieve directly from unselected_items_dict which stores the full tuple
        ...
        for unsel_density, unsel_value, unsel_weight, unsel_idx in temp_unselected_items_list_by_value:
            ...
            if unsel_weight > capacity: # Optimization for very large unselected items
                continue
        ...
        if best_1for1_value_gain > 0:
            ...
            # Use item_properties for O(1) lookup of density, value, weight for the item becoming unselected
