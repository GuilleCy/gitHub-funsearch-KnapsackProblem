def heuristic(items_state):
    ...
    while improvement_made:
        ...
        # This phase handles cases where 0-weight items might have been temporarily unselected
        # during a previous swap, or ensures robustness if initial greedy pass missed any.
        ...
        # Using temp_selected_item_info_by_weight_desc to prioritize freeing up maximum capacity
        for sel_weight, sel_value, sel_idx in temp_selected_item_info_by_weight_desc: # Note order of (weight, value, idx)
            ...
            # Greedily fill available_capacity with unselected items (high density first)
