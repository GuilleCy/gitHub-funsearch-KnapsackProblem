    ...
    while improvement_made:
        ...
        for unsel_density, unsel_value, unsel_weight, unsel_idx in temp_unselected_items_list_by_value:
            ...
            for sel_value, sel_weight, sel_idx in temp_selected_item_info:
                # This check is needed because temp_selected_item_info is a snapshot from the start of the while loop.
                # An item might have been removed by a 0-weight item addition or a previous swap in an outer iteration.
        ...
        for sel_value, sel_weight, sel_idx in temp_selected_item_info:
            # This check is needed for the same reason as in Phase 1.
            if sel_idx not in current_selected_items_indices:
                continue
            ...
            for unsel_density, unsel_value, unsel_weight, unsel_idx_to_add in temp_unselected_items_list_by_density:
                # Removed redundant check: 'unsel_idx_to_add in current_selected_items_indices or unsel_idx_to_add == sel_idx'
                # as items in temp_unselected_items_list_by_density are guaranteed to be unselected and not equal to sel_idx.
        ...
        for i in range(len(temp_selected_item_info)):
            ...
            for j in range(i + 1, len(temp_selected_item_info)):
                ...
                for unsel_density, unsel_value, unsel_weight, unsel_idx in temp_unselected_items_list_by_value:
                    ...
                    # Removed redundant check: 'unsel_idx in current_selected_items_indices or unsel_idx == sel1_idx or unsel_idx == sel2_idx'
                    # as items in temp_unselected_items_list_by_value are guaranteed to be unselected and not equal to sel1_idx or sel2_idx.
