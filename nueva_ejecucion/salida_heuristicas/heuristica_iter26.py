    ...
    while improvement_made:
        ...
        for unsel_density, unsel_value, unsel_weight, unsel_idx in temp_unselected_items_list_by_value:
            ...
            if unsel_weight == 0 and unsel_value > 0:
                ...
                # IMPROVEMENT: O(1) removal from dictionary.
            ...
            for sel_value, sel_weight, sel_idx in temp_selected_item_info:
                ...
                if current_total_weight + weight_change <= capacity and value_change > 0:
                    ...
                    # IMPROVEMENT: O(1) updates for unselected_items_dict.
        ...
        if not improvement_made:
            ...
            for sel_value, sel_weight, sel_idx in temp_selected_item_info:
                ...
                # The checks unsel_idx_to_add in current_selected_items_indices and unsel_idx_to_add == sel_idx
                # are redundant here because temp_unselected_items_list_by_density is derived from
                # unselected_items_dict, which is disjoint from current_selected_items_indices.
                # Also, sel_idx is currently in current_selected_items_indices, thus not in unselected_items_dict.
