def heuristic(items_state):
    ...
    # item_properties[original_index] = (density, value, weight, original_index)
    item_properties = {} 
    for i in range(num_items):
        ...
        # Store the full tuple in item_properties for consistency
        item_properties[i] = (density, values[i], weights[i], i) 
    ...
    while improvement_made:
        ...
        if best_1for1_value_gain > 0:
            ...
            # Add the removed item (best_1for1_sel_idx) back to unselected_items_dict using item_properties
            unselected_items_dict[best_1for1_sel_idx] = item_properties[best_1for1_sel_idx]
        ...
        if best_1fork_value_gain > 0:
            ...
            unselected_items_dict[best_1fork_sel_idx] = item_properties[best_1fork_sel_idx]
        ...
        if best_2for1_value_gain > 0:
            ...
            # Add the removed items back to unselected_items_dict using item_properties
            unselected_items_dict[best_2for1_sel1_idx] = item_properties[best_2for1_sel1_idx]
            unselected_items_dict[best_2for1_sel2_idx] = item_properties[best_2for1_sel2_idx]
