def heuristic(items_state):
    ...
    while improvement_made:
        ...
        for unsel_density, unsel_value, unsel_weight, unsel_idx in temp_unselected_items_list_by_value:
            ...
            for sel_value, sel_weight, sel_idx in temp_selected_item_info_by_value_asc: # Use value_asc list
        ...
        # Using temp_selected_item_info_by_weight_desc to prioritize removing heavier items to free up more capacity
        ...
        for i in range(len(temp_selected_item_info_by_value_asc)): # Use value_asc list
