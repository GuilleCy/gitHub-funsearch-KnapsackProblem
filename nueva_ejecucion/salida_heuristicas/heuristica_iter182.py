def heuristic(items_state):
    ...
    while improvement_made:
        ...
        for idx in current_selected_items_indices:
            temp_selected_item_info_by_weight_desc.append((weights[idx], values[idx], idx)) # Store as (weight, value, idx)
        ...
        for sel_weight, sel_value, sel_idx in temp_selected_item_info_by_weight_desc: # Use weight_desc for 1-for-k
        ...
        for i in range(len(temp_selected_item_info_by_value_asc)): # Use value_asc for 2-for-1
            ...
            for j in range(i + 1, len(temp_selected_item_info_by_value_asc)): # Use value_asc for 2-for-1
