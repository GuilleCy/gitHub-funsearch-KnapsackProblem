def heuristic(items_state):
    ...
    while improvement_made:
        ...
        # This list is only needed in Phase 2, but creating it here simplifies the code structure.
        ...
        for unsel_density, unsel_value, unsel_weight, unsel_idx in temp_unselected_items_list_by_value:
            ...
            for sel_value, sel_weight, sel_idx in temp_selected_item_info:
                ...
                # PRUNING REMOVED: The previous pruning 'if unsel_value <= sel_value: break' was incorrect
                # because temp_selected_item_info is sorted by sel_value ascending.
                # It would prematurely stop checking for valid swaps.
                # The 'value_change > 0' condition below correctly handles value improvement.
