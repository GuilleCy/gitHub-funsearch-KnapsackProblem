    ...
    while improvement_made:
        ...
        for sel_value, sel_weight, sel_idx in temp_selected_item_info:
            ...
            for unsel_density, unsel_value, unsel_weight, unsel_idx_to_add in temp_unselected_items_list_by_density:
                ...
                # Pruning: If no more capacity for weighted items, break.
                # This check is after 0-weight items, as they don't consume capacity.
                if available_capacity - potential_add_weight == 0:
                    break # No more capacity for weighted items
